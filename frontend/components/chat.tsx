...
export default function Chat() {
    ...
    return (
        <div className="flex h-screen max-w-5xl mx-auto p-4">
            <Card className="flex-1 flex-col shadow-xl overflow-hidden">
                {/**Header */}
                ...
                <ScrollArea ref={scrollAreaRef} className="flex-1 min-h-0">
                    <div className="p-4 space-y4 pb-4">
                        ...
                        {
                            error && (
                                <div className="flex jsutify-center px-4">
                            ...
                            <form onSubmit={handleSubmit} className="flex-gap-2">
                                <input
                                    ...
                                    className={cn(
                                        ...
                                        "focus:outline-one focus:ring-2 focus:ring-ring focus:ring-offset-2",
